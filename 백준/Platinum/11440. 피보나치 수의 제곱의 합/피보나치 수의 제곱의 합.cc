...
int main(void)
{
	...
	result1[1][1] = 0;
	ary solve2 = ary(n);
	ll** result2 = (ll**)malloc(sizeof(ll) * 2);
	for (int i = 0; i < 2; i++)
	{
		result2[i] = (ll*)malloc(sizeof(ll) * 2);
	}
	result2[0][0] = 1;
	result2[0][1] = 1;
	result2[1][0] = 1;
	result2[1][1] = 0;
	cout << antioverflow::mulmod(solve2.arypow(result2, 1000000007)[0][0], solve1.arypow(result1, 1000000007)[0][0], 1000000007) % 1000000007;
}