...
int main(void) {
	...
	Primefactor pf;
	vector<ll>prime;
	vector<bool>vi = pc.eratosthenes(5000);
	...
	while (num--) {
		...
		pf.factorialfactor(a, prime, aup);
		pf.factorialfactor(c, prime, cup);
		pf.factorialfactor(b, prime, adown);
		pf.factorialfactor(a - b, prime, adown);
		pf.factorialfactor(d, prime, cdown);
		pf.factorialfactor(c - d, prime, cdown);
